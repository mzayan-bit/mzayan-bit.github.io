...
const projects = [
  {
    id: "visionforge",
    title: "VisionForge",
    tech: ["PyTorch", "FastAPI", "SigLIP 768D", "YOLO11", "Grad-CAM", "Next.js 16"],
    desc: "Open-source Computer Vision Research Workbench & XAI engine unifying inference, evaluation, and dataset quality auditing across 247+ automated tests.",
    challenges: "Eliminating train-test leakage across dataset splits and designing an 8-stage finite state machine lineage DAG engine using JSON-LD cryptographic hashes and Bessel-corrected statistics for experiment reproducibility.",
    outcomes: "Engineered a SHA-256 payload hashing and 768D SigLIP cosine similarity (≥ 0.92) quality pipeline, and developed a PyTorch Grad-CAM explainability module computing spatial bounding box concentration ratios (∫∫_BBox H / ∫∫_Image H).",
    link: "https://github.com/mzayan-bit/VisionForge",
    img: "/images/visionforge.png",
  },
  {
    id: "visiontraceai",
    title: "VisionTraceAI",
    tech: ["React", "FastAPI", "Kafka", "YOLO11", "SigLIP", "LangGraph"],
    desc: "Real-time event-driven video intelligence platform featuring cross-camera tracking, zero-shot semantic video search, and an autonomous LangGraph supervisor agent.",
    challenges: "Architecting a low-latency distributed streaming pipeline using Apache Kafka, WebSockets, and Redis to process multiple camera feeds concurrently without bottlenecking the inference engine.",
    outcomes: "Achieved sub-100ms latency for real-time tracking across 4+ camera feeds with YOLO11 and FastReID, and integrated Google's SigLIP with Qdrant vector database for natural language text-to-video retrieval.",
  ...
  },
  {
    id: "sentinelops",
    title: "SentinelOps",
    tech: ["YOLO11s", "FastAPI", "DVC", "MLflow", "Evidently AI", "PostgreSQL", "Redis"],
    desc: "End-to-end industrial PPE safety detection and MLOps pipeline achieving 96.4% mAP@50 and 93.3% Precision on 4,864 labeled PPE instances.",
    challenges: "Ensuring continuous model quality, automated dataset versioning, experiment lineage tracking, and real-time live stream drift monitoring in high-consequence industrial safety environments.",
    outcomes: "Deployed a low-latency FastAPI inference service with OpenCV tracking, privacy facial blurring, PostgreSQL, Redis, DVC dataset versioning, MLflow tracking, and Evidently AI drift detection.",
    link: "https://github.com/mzayan-bit/SentinelOps",
    img: "/images/sentinelops.png",
  },
  {
    id: "gitverse",
    title: "GitVerse",
    tech: ["Next.js 16", "Three.js", "WebGL2", "TypeScript", "AST Parsers", "LangGraph"],
    desc: "3D spatial software engineering & architecture intelligence engine rendering complex codebase dependency graphs as interactive 3D solar systems at 60 FPS.",
    challenges: "Parsing raw multi-language abstract syntax trees (AST) into high-performance 3D scene graphs and calculating structural blast radius propagation vectors without causing UI thread stutter.",
    outcomes: "Engineered a WebGL2/Three.js spatial engine with cubic Bézier spline keynote camera fly-throughs, state-synchronized copilot teleprompter, and circular architectural dependency detection.",
    link: "https://github.com/mzayan-bit/GitVerse",
    img: "/images/gitverse.png",
  },
  {
    id: "aigymvision",
    title: "AI Gym Vision",
  ...
  },
  {
    ...
    desc: "IPO recommendation engine and KNN classification model utilizing TF-IDF vectorization and Cosine Similarity to map user skill profiles.",
